...
st.header("Correlation Coefficients") 
col1, col2 = st.columns(2)
with col1:
    st.subheader("Emissions v. Temperature")
    st.write("USA: 0.471 - moderate positive correlation")
    st.write("Canada: 0.489 - moderate positive correlation")
with col2:
    st.subheader("Emissions v. Disasters")
    st.write("USA: 0.373 - low to moderate positive correlation")
    st.write("Canada: 0.447 - moderate positive correlation")
...
st.write("I would say that CO2 emissions definetly do have some sort of a correlation to the increasing trend in global temperatures. This is most evidently seen by  both the USA and Canada CO2 emissions and Temperature Scatterplot. The correlation coefficient for the graphs are 0.471 and 0.489 respectively, which indicates a moderately positive correlation between the two variables. As with its association with natural disaster rates, there also seems to be a slight positive correlation as in the plot Canada CO2 emissions and Disasters Scatterplot the correlation coefficient between the two variables is 0.447. However, the correlation between the number of disasters and CO2 emissions for the US is less strongly related as the correlation coefficient is only 0.373.")
